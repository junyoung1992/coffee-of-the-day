...
- 카페 로그 / 브루 로그 생성, 조회, 수정, 삭제
- 날짜, 동행인, 메모 등 공통 정보 기록
- 카페: 이름, 메뉴, 원두 정보, 테이스팅 태그, 평점
- 브루: 추출 방식, 도구, 원두량, 물량, 온도, 시간, 분쇄도, 추출 단계
- 타입(카페/브루) 및 날짜 범위 필터
- 무한 스크롤 목록 탐색
- 이전 입력 기반 테이스팅 태그 / 동반자 자동완성
...
| Frontend | React, TypeScript, Vite, TanStack Query, Tailwind CSS v4, React Router |
| Test | Go testing, Playwright (E2E) |
| API | OpenAPI 3.0 |
