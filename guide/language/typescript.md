# TypeScript 학습 가이드 — Phase 1-2 코드 따라가기

> 대상 독자: Java/Spring 개발자  
> 목표: Coffee of the Day Phase 1-2 프론트 코드를 읽을 때 필요한 TypeScript와 React 문법을 빠르게 익힌다.
...
## 21. 이 프로젝트에서 꼭 익혀야 할 TypeScript 우선순위

Phase 1-2 프론트를 리뷰하려면 아래 순서가 가장 효율적입니다.
...
이 정도면 Phase 1-2 프론트는 대부분 읽을 수 있습니다.
...
8. `frontend/src/pages/LogDetailPage.tsx`
9. `frontend/src/pages/LogFormPage.tsx`
10. `frontend/e2e/log-happy-path.spec.ts`
   실제 사용자 흐름 검증 방식 이해
...
이 흐름까지 잡히면 Phase 1-2 프론트 코드는 훨씬 읽기 쉬워집니다.
